...
export type MagneticButtonCircularProps = AnchorProps | ButtonProps;

const MagneticButtonCircular = memo(
  forwardRef<HTMLElement, MagneticButtonCircularProps>(
    function MagneticButtonCircular(props, forwardedRef) {
      ...
      return (
        ...
        >
          <div
            ref={fillRef}
            className={cn(
              "btn-fill absolute left-[-2%] top-[-70%] rounded-[50%] w-[105%] h-[120%] pointer-events-none will-change-transform",
              fillClassName
            )}
            style={{
              transform: `translateY(${
                isZoomDetail ? ZOOM_HIDDEN_Y : HIDDEN_Y
              })`,
            }}
          />
          <span
...
export default MagneticButtonCircular;

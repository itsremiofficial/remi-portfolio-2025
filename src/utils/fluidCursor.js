...
`
  ...
  function generateColor() {
    // Base color #d93535 converted to RGB (0-1 range)
    const baseColor = {
      r: 0.851, // 217/255
      g: 0.208, // 53/255
      b: 0.208, // 53/255
    ...
    // Multiple predefined shades of your red color
    const shades = [
      { r: 0.4, g: 0.098, b: 0.098 }, // Very dark red
      { r: 0.551, g: 0.135, b: 0.135 }, // Dark red
      { r: 0.702, g: 0.172, b: 0.172 }, // Medium-dark red
    ...
    // Apply the dimming factor for the fluid effect
    return {
      r: shade.r * 0.15,
      g: shade.g * 0.15,
      b: shade.b * 0.15,
